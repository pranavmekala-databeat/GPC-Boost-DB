...
WITH future_ppr AS (
      SELECT ranked_future_ppr."sku", ranked_future_ppr."company",
             ranked_future_ppr."pricePoint6IncludingGst", ranked_future_ppr."startDate"
      FROM (
